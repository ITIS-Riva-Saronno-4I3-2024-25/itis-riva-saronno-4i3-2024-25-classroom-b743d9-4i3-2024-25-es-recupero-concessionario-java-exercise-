...
public abstract class Veicolo
{
    ...
    public abstract TipoVeicolo getTipoVeicolo();
    ...
    public String toString() {
        return String.format("%s: %s, %s del %d (%d anni), %.2f €, omologata per %d",
                targa, getTipoVeicolo().name().toLowerCase(), getNomeCompletoModello(), annoProduzione, calcolaEtaVeicolo(), prezzo, getNumeroPosti());
    }
